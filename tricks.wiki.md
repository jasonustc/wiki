...
- approximately, if we want the losses to contribute equally to the gradients of the network, we can adjust loss weights to make sure that $$loss_i * {loss_{weight}}_i$$ is with the same magnitude.
